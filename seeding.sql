...
(customer_id, customer_name, phone_number, email, address, city, state_province, country, postal_code)
VALUES
...
(staff_id, salesperson_name, store)
VALUES
...
(invoice_number, invoice_date, car_id, customer_id, salesperson_id)
VALUES
