...
(5, 'HKNDGS7CU31E9Z7JW', 'Toyota', 'RAV4', 2018, 'Silver'),
(6, 'DAM41UDN3CHU2WVF6', 'Volvo', 'V60 Cross Country', 2019, 'Gray');

INSERT INTO customers
(customer_id, customer_code, customer_name, phone_number, email, address, city, state_province, country, zip_postal_code)
VALUES
...
(salesperson_id, staff_id, salesperson_name, store)
VALUES
...
(invoice_id, invoice_number, invoice_date, car_id, customer_id, salesperson_id)
VALUES
